...
QT_MOC_LITERAL(1, 15, 16), // "SigHeadPicActive"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 10), // "OnLoginBtn"
QT_MOC_LITERAL(4, 44, 7), // "OnClose"
QT_MOC_LITERAL(5, 52, 11) // "OnVerifyBtn"

    },
    "LoginInterface\0SigHeadPicActive\0\0"
    "OnLoginBtn\0OnClose\0OnVerifyBtn"
};
...
void LoginInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SigHeadPicActive(); break;
        case 1: _t->OnLoginBtn(); break;
        case 2: _t->OnClose(); break;
        case 3: _t->OnVerifyBtn(); break;
        default: ;
        }
        ...
        {
            typedef void (LoginInterface::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginInterface::SigHeadPicActive)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject LoginInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LoginInterface.data,
      qt_meta_data_LoginInterface,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void LoginInterface::SigHeadPicActive()
{
